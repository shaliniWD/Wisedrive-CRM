...
export const DTC_DESCRIPTIONS: Record<string, string> = {
  ...
  'P1624': 'Immobilizer Communication Error with EMS',
  'P1625': 'Immobilizer ID Registration Mismatch',
  'P1634': 'Data Link',
  'P1665': 'Power Stage Group A',
  'P1670': 'Output Speed Sensor Signal Missing',
  'P1690': 'Fuel Injector Fault Cylinder 1',
  'P1693': 'Fuel Injector Fault Cylinder 4',
  ...
  'P1403': 'EGR Insufficient Flow Detected',
  'P1404': 'EGR Stuck Closed',
  'P1405': 'EGR Stuck Open',
  'P1441': 'EVAP System Flow During Non-Purge',
  'P1450': 'Unable to Bleed Up Fuel Tank Vacuum',
  'P1604': 'Throttle Actuator Control Module Range Check',
  ...
  'P1628': 'Fuel Injector Group 2 Supply Voltage',
  ...
  'P1631': 'Theft Deterrent Start Enable Signal Not Received',
  'P1632': 'Theft Deterrent Fuel Enable Signal Not Received',
  'P1654': 'A/C Relay Circuit',
  'P1655': 'Starter Motor Relay Circuit',
  'P1656': 'Fuel Pump Relay Circuit',
  'P1658': 'Main Relay Circuit',
  ...
  'P1340': 'Ignition Coil Circuit',
  'P1345': 'VVT Sensor (Bank 1) Circuit',
  ...
  'P1600': 'ECM Communication Error',
  'P1605': 'Knock Control CPU',
  'P1633': 'ECM',
  'P1656': 'OCV (Oil Control Valve) Circuit',
  'P1693': 'OCV (Oil Control Valve) Circuit',
  ...
  'P1129': 'MAP Sensor Higher Than Expected',
  'P1149': 'Primary HO2S (Sensor 1) Circuit Range/Performance',
  'P1157': 'A/F Sensor (Sensor 1) Low Voltage',
  'P1158': 'A/F Sensor (Sensor 1) High Voltage',
  'P1159': 'A/F Sensor (Sensor 1) Slow Response',
  ...
  'P1166': 'A/F Sensor (Sensor 1) Heater System Electrical',
  'P1167': 'A/F Sensor (Sensor 1) Heater System Electrical',
  'P1168': 'Primary HO2S Sensor 1 Label Circuit Low',
  ...
  'P1244': 'Insufficient Closed Throttle Position Detected',
  ...
  'P1607': 'ECM/PCM Internal Circuit',
  'P1618': 'Control Module Data Line Error',
  'P1676': 'FPTDR Signal Line Output',
  'P1677': 'FPTDR Signal Line Output',
  'P1678': 'FPCM Disconnection',
  'P1681': 'A/T FI Signal A',
  'P1682': 'A/T FI Signal A',
  'P1683': 'A/T FI Signal B',
  'P1684': 'A/T FI Signal B',
  ...
  'P1335': 'CKP Sensor Circuit',
  'P1336': 'CKP Sensor Circuit Range/Performance',
  'P1400': 'EGRC Solenoid',
  ...
  'P1564': 'ASCD Vehicle Speed Sensor',
  'P1565': 'ASCD Steering Switch',
  'P1572': 'Brake Pedal Switch Circuit',
  'P1574': 'ASCD Vehicle Speed Sensor',
  'P1600': 'A/T Signal',
  'P1610': 'Lock Mode',
  'P1611': 'Lock Key',
  'P1612': 'NATS Communication Error',
  'P1614': 'NATS Malfunction',
  'P1615': 'NATS Control Unit',
  'P1625': 'Communication Line',
  ...
  'P1189': 'Fuel Rail Pressure Regulator',
  'P1219': 'Throttle Actuator Motor Current',
  'P1221': 'Accelerator Position Sensors',
  'P1222': 'Throttle Position Actuator',
  'P1225': 'Throttle Actuator B',
  'P1226': 'Accelerator Position Sensor 1',
  'P1227': 'Accelerator Position Sensor 2',
  'P1343': 'Misfire Cylinder 1 With Fuel Cut-Off',
  'P1344': 'Misfire Cylinder 2 With Fuel Cut-Off',
  'P1345': 'Misfire Cylinder 3 With Fuel Cut-Off',
  'P1346': 'Misfire Cylinder 4 With Fuel Cut-Off',
  'P1347': 'Misfire Cylinder 5 With Fuel Cut-Off',
  'P1348': 'Misfire Cylinder 6 With Fuel Cut-Off',
  'P1396': 'Camshaft Position Sensor B Circuit',
  'P1397': 'Camshaft Position Sensor Bank 2',
  'P1417': 'Secondary Air Mass Flow Sensor',
  'P1418': 'Secondary Air Mass Flow Sensor',
  'P1500': 'Idle Speed Control Valve Opening Coil',
  'P1501': 'Idle Speed Control Valve Closing Coil',
  'P1502': 'Idle Speed Control Valve Closing Coil',
  'P1519': 'Intake Camshaft Control Bank 1',
  'P1520': 'Intake Camshaft Control Bank 1',
  'P1523': 'Intake Camshaft Control Bank 2',
  'P1524': 'Intake Camshaft Control Bank 2',
  'P1530': 'A/C Pressure Sensor Circuit',
  'P1542': 'Throttle Actuator Control Range',
  'P1544': 'Exhaust Gas Temperature Sensor Circuit',
  'P1545': 'Throttle Position Control Malfunction',
  'P1602': 'Voltage Supply B+ Terminal',
  'P1610': 'EWS Control Module',
  'P1611': 'EWS Transmission Type',
  'P1612': 'EWS ECU ID Not Matched',
  'P1613': 'EWS Key Not Received',
  'P1614': 'Starter Disable Relay',
  'P1637': 'Exhaust Camshaft Control Bank 1',
  'P1638': 'Exhaust Camshaft Control Bank 2',
  'P1639': 'Accelerator Position Sensors',
  ...
  'P1130': 'O2 Sensor Signal Inverted (Bank 1)',
  'P1131': 'O2 Sensor Signal Inverted (Bank 2)',
  'P1186': 'ME-SFI Control Module',
  'P1187': 'ME-SFI Control Module',
  'P1188': 'ME-SFI Control Module',
  'P1229': 'Fuel Pressure Limiting',
  'P1235': 'Fuel Pressure',
  'P1280': 'A/C Refrigerant Pressure Circuit High',
  'P1281': 'A/C Refrigerant Pressure Circuit Low',
  'P1386': 'Knock Control',
  'P1388': 'Knock Sensor Shield Ground Open',
  'P1442': 'Fuel Tank Level Too Low',
  'P1453': 'Atmospheric Pressure',
  'P1455': 'A/C-Heat Evaporator Temp. Sensor',
  'P1462': 'Air Pump Shutoff Valve',
  'P1463': 'Air Pump',
  'P1469': 'Air Pump Relay Circuit',
  'P1470': 'Leak Diagnostic Pump',
  'P1519': 'Intake Manifold Switchover Valve',
  'P1542': 'Throttle Position Controller',
  'P1543': 'Throttle Position Controller Performance',
  'P1580': 'Electronic Throttle Controller',
  'P1581': 'Idle Speed Not Obtained',
  'P1585': 'Idle Speed Control',
  'P1586': 'Idle Speed Control',
  'P1587': 'Idle Speed',
  'P1618': 'Glow Plug Relay',
  'P1631': 'Accelerator Position Sensor 2',
  'P1633': 'Accelerator Position Sensor 1',
  ...
  'P1336': 'CKP/CMP Sensor Range/Performance',
  'P1340': 'Camshaft Position Sensor B Circuit Malfunction',
  'P1345': 'CMP Sensor A (Bank 1) Circuit Malfunction',
  ...
  'P1443': 'EVAP System - Loss Of Vacuum',
  'P1444': 'EVAP Purge Flow Sensor',
  'P1450': 'Unable to Bleed Up Fuel Tank Vacuum',
  'P1451': 'EVAP System - Loss Of Prime',
  'P1455': 'EVAP System Gross Leak/No Flow',
  'P1460': 'WOT A/C Cut-Off Relay Circuit',
  'P1461': 'A/C Pressure Sensor High',
  'P1462': 'A/C Pressure Sensor Low',
  ...
  'P1519': 'Intake Manifold Runner Control Malfunction (Stuck Closed)',
  'P1537': 'Intake Manifold Runner Control Malfunction (Bank 1 Stuck Open)',
  ...
  'P1550': 'PSP Switch Out of Self-Test Range',
  'P1565': 'Speed Control Command Switch Out of Range',
  'P1601': 'ECM/TCM Serial Communication Error',
  'P1605': 'Keep Alive Memory Test Error',
  'P1633': 'KAM Voltage Too Low',
  'P1635': '5 Volt Reference A Out of Range',
  'P1636': 'Inductive Signature Chip Communication',
  ...
  'P1746': 'EPC Solenoid Short Circuit',
  ...
  'P1498': 'High Speed Radiator Fan Ground Ctrl Relay',
  ...
  'P1603': 'Internal ECM Failure-EEPROM Write Denied',
  'P1682': 'Charging System Voltage Too Low',
  'P1683': 'Speed Control Power Relay or S/C 12V Driver',
  ...
  'P1690': 'Fuel Injection Pump CKP Sensor Does Not Agree',
  'P1691': 'Fuel Injection Pump Controller Calibration',
  'P1693': 'Generic Fault - Check Other DTC',
