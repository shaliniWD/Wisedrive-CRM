...
import { 
  ...
  FileText, Clock, CheckCircle, AlertCircle, ChevronDown, ChevronUp,
  Send, Edit2, Save, MessageSquare, Activity
} from 'lucide-react';
          ...
          <div className="flex-1 overflow-hidden flex flex-col">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col overflow-hidden">
              <TabsList className="px-6 pt-2 pb-0 bg-white border-b shrink-0 justify-start rounded-none h-auto">
                <TabsTrigger 
                  value="overview" 
                  className="rounded-t-lg rounded-b-none border-b-2 border-transparent data-[state=active]:border-blue-600 data-[state=active]:bg-transparent"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    {isEditing ? (
                      ...
                      <div className="px-3 py-2 bg-gray-50 rounded border text-sm">{customer.name}</div>
                    )}
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    {isEditing ? (
                      ...
                      <div className="px-3 py-2 bg-gray-50 rounded border text-sm font-mono">{customer.mobile}</div>
                    )}
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    {isEditing ? (
                      ...
                      <div className="px-3 py-2 bg-gray-50 rounded border text-sm">{customer.city || '-'}</div>
                    )}
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    {isEditing ? (
                      ...
                      <div className="px-3 py-2 bg-gray-50 rounded border text-sm">{customer.email || '-'}</div>
                    )}
                  </div>
                  ...
                  <div className="col-span-2 space-y-1.5">
                    ...
                    {isEditing ? (
                      ...
                      <div className="px-3 py-2 bg-gray-50 rounded border text-sm">{customer.address || '-'}</div>
                    )}
                  </div>
                </div>
