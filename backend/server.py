...
# ==================== VERSION & HEALTH ====================
APP_VERSION = "2.5.9"
APP_BUILD_DATE = "2026-03-05T09:50:00Z"
...
async def get_version():
    ...
    return {
        ...
        "recent_changes": [
            "v2.5.9 - ROOT CAUSE FIXED: routes/mechanic.py had response_model causing Pydantic validation error when car_year is int",
...
async def debug_mechanic_inspections(
    ...
    """Debug endpoint to diagnose inspection loading issues"""
    import traceback
    mechanic_id = current_user["id"]
    mechanic_cities = current_user.get("inspection_cities", [])
    mechanic_name = current_user.get("name", "")
    ...
    debug_info = {
        "mechanic_id": mechanic_id,
        "mechanic_name": mechanic_name,
        "mechanic_cities": mechanic_cities,
        "inspections_found": 0,
        "raw_inspections": [],
